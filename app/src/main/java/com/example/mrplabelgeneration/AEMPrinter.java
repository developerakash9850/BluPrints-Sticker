...
//	UsbController usbCtrl = null;
	...
	public byte[] POS_CENTER = new byte[]{27, 97, 1}; // CENTER

	public void POS_ThreeInchCENTER() throws IOException {
		byte[] data = byteArraysToBytes(new byte[][]{POS_CENTER});
	...
	public byte[] ESC_font_bold = new byte[]{27, 33, 8};
...
//	public static final byte DOUBLE_WIDTH = 0X04;
	...
	public void setLineFeed(Float noOfFeeds) throws IOException
	{
...
//		
	...
	public void printImage(Bitmap resizedBitmap) {
		...
		PrintRasterImage.PrepareImage(com.example.mrplabelgeneration.PrintRasterImage.dither.floyd_steinberg, 128);
	...
	public void printBarcode(String barcodeData, BARCODE_TYPE barcodetype, BARCODE_HEIGHT barcodeheight) throws IOException
{
	...
	{
	    Bitmap resizedBitmap = Bitmap.createScaledBitmap(originalBitmap, 500, originalBitmap.getHeight(), false);
